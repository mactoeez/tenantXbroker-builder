          ...
          <Card className="p-12 border-0 shadow-xl bg-white/90 backdrop-blur-sm">
            <CardContent className="p-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                {description ||
                  `We're working hard to bring you the ${pageName.toLowerCase()} page. Check back soon for exciting new features!`}
              </p>

              <div className="space-y-4">
                <p className="text-gray-500">
                  In the meantime, continue exploring RentConnect to find your
                  perfect home.
                </p>
